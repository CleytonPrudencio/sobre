...
<body>
	...
	<main>
		...
		<div class="container-fluid d-flex justify-content-center"
			...
			<form action="ServletCatBrinquedo?cmd=atualizar" method="post">
				<p class="d-flex justify-content-center mt-3 font-weight-bold">Consulta de Categoria</p>
				<div class="form-row">
					<div class="form-group col-md-12">
						<label for="Codigo">Codigo Categoria</label> <input type="txt"
							class="form-control" name="txtCod" id="Codigo" placeholder="1"
							value="<%=categoria.getCod_categoria()%>"  readonly="readonly"  />
					</div>
					<div class="form-group col-md-12">
						<label for="nome">Nome Categoria</label> <input type="txt"
							class="form-control" name="txtNome" id="nome" placeholder="1"
							value="<%=categoria.getNomeCategoria()%>" readonly="readonly" />
					</div>
					<div class="form-group col-md-12">
						<label for="linha">Linha Categoria</label> <input type="txt"
							class="form-control" name="txtLinha" id="linha" placeholder="1"
							value="<%=categoria.getLinhaCategoria()%>" readonly="readonly" />
					</div>
					<div class="form-group col-md-12">
						<label for="faixa">Faixa Categoria</label> <input type="txt"
							class="form-control" name="txtFaixa" id="faixa" placeholder="1"
							value="<%=categoria.getFaixaCategoria()%>" readonly="readonly" />
					</div>
