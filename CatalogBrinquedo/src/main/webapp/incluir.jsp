...
<body>
	...
	<main>
	<div class="container-fluid d-flex justify-content-center" style="font-family: Comic Sans MS;color: rgb(1, 79, 145); font-size:20px;">
	<form action="ServletCatBrinquedo" method="get">
			<input type="hidden" name="cmd" value="incluir">
			<p class="d-flex justify-content-center mt-3 font-weight-bold">Cadastro de Categorias</p>
			 <div class="form-row">
			<div class="form-group col-md-12">
				<label for="Codigo">Codigo Categoria</label> 
				<input
					type="txt" class="form-control" name="txtCod" id="Codigo"
					placeholder="1">
			</div>
			<div class="form-group col-md-12">
				<label for="Nome">Nome Categoria</label> 
				<input
					type="txt" class="form-control" name="txtNome" id="Nome"
					placeholder="Carrinho">
			</div>
			<div class="form-group col-md-12">
				<label for="Linha">Linha</label> 
				<input
					type="txt" class="form-control" name="txtLinha" id="Linha"
					placeholder="Masculino">
			</div>
			<div class="form-group col-md-12">
				<label for="Faixa">Faixa Categoria</label> 
				<input
					type="txt" class="form-control" name="txtFaixa" id="Faixa"
					placeholder="10 anos">
			</div>
			<div class="col-md-12 d-flex justify-content-center" >
			<input type="submit" class="btn btn-warning"  value="Enviar" style="width:10rem;"></button>
			</div>
